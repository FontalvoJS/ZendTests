...
abstract class Zend_Controller_Action implements Zend_Controller_Action_Interface
{
    ...
    public function responseJson($http_status_code, $data, $indexMessage, $message)
    {
        $this->_helper->viewRenderer->setNoRender();
        $this->getResponse()->setHttpResponseCode($http_status_code);
        $this->getResponse()->setHeader('Content-Type', 'application/json');
        $this->getResponse()->setBody(json_encode([$indexMessage => $message]));
        return $this->getResponse();
    }
    public function getObjectRequest() {
        return json_decode($this->getRequest()->getRawBody(), true);
    }
    /**
